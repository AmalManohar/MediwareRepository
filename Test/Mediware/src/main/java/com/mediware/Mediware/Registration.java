...
public class Registration extends Base{
	...
	@Test
	public void areg() throws Exception {
	    ...
	    WebElement nationalityName = driver.findElement(By.xpath(prop.getProperty("nationality")));
	    Thread.sleep(2000);
	    ...
	    WebElement emiratesName = driver.findElement(By.xpath(prop.getProperty("emirates")));
	    Thread.sleep(3000);
	...
	@Test
	public void bforeign() throws Exception {
