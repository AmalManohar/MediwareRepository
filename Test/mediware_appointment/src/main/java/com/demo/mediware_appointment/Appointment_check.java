...
public class Appointment_check {
	...
	public void select_investigation() throws Exception {
		Thread.sleep(1000);
		WebElement investigation_click=objElements.select_investigation();
		investigation_click.click();
	}
	public void enter_investigation() throws Exception {
		WebElement switch_frame=driver.findElement(By.xpath(prop.getProperty("DivMainPage")));
		driver.switchTo().frame(switch_frame);
		WebElement confirm_investigation=objElements.enter_investigation();
		confirm_investigation.click();
	}
